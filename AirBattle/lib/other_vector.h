...
/*!
	\brief	Ìèíèìàëüíàÿ äëèíà ìàññèâà.
	Äëÿ òîãî ÷òîáû èçáåæàòü ÷àñòîãî èçìåíåíèÿ ðàçìåðà ìàññèâà ïðè íàäîáíîñòè óâåëè÷èòü åãî ïðîèçîéäåò óâåëè÷åíèå íà 4 ÿ÷åéêè.
*/
#include <memory>
/*!
	\brief Èòåðàòîð äëÿ other_vector.
*/
template <class T>
class other_iterator;
/*!
	\brief Øàáëîí âåêòîðà other_vector.
*/
template <class T>
class other_vector {
private:
...
public:
	/*!
	\brief Èíèöèàëèçèðóþùèé êîíñòðóêòîð.
	Âûäåëÿåòñÿ ïàìÿòü ïîä 4 îáúåêòà .
	*/
...
template <class T>
other_vector<T>& other_vector<T>::operator =(const other_vector<T>& a) {//áûë äåëèò
	resize(a.capacity);

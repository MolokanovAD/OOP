...
#define L 6
/*!
	\brief Пространство имен для игры "Сражение эскадрилий"
*/
namespace AirBattle {
	/*!
		\brief Самолет противоракетной обороны.
		Содержит текущее количество зарядов ПРО и максимальное количество зарядов ПРО. Способен с высокой вероятностью избежать получения урона от ракеты.
	*/
	class Anti_Rocket : public Plane {
	protected:
		/*!
			\brief Текущее количество зарядов ПРО
		*/
		int pro;
		/*!
			\brief Максимальное количество зарядов ПРО
		*/
		int pro_max;

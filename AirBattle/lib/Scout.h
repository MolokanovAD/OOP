...
namespace AirBattle {
	/*!
		\brief Самолет-разведчик.
		Содержит коэффициент игнорирования маскировки. Обладает большим радиусом обнаружения и высокой скоростью, но небольшим запасом прочности.
	*/
	class Scout :public Plane {
	protected:
		/*!
			\brief Коэффициент игнорирования вражеских систем маскировки
		*/
		double ignore_coef;
